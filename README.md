...
Installation: <BR>
The Bootloader https://github.com/pelrun/uf2loader/releases/download/v2.3/bootloader_pico.uf2 is flashed to the Pico via USB <BR><BR>
...
U2F files to be loaded in SD_ROOT/pico1-apps <BR><BR>

For a PICO2 <BR>
BBOOT2350.uf2 file needs to live in SD_ROOT <BR>
U2F files to be loaded in SD_ROOT/pico2-apps <BR><BR>
